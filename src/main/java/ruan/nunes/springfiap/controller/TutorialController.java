package ruan.nunes.springfiap.controller;
...
import ruan.nunes.springfiap.repository.TutorialRepository;
...
public class TutorialController {
  ...
  public ResponseEntity<List<Tutorial>> getAllTutorials(@RequestParam(required = false) String title) {
    try {
      ...
      else tutorialRepository.findByTitleContainingIgnoreCase(title).forEach(tutorials::add);
  ...
  public ResponseEntity<Tutorial> updateTutorial(@PathVariable("id") long id, @RequestBody Tutorial tutorial) {
    ...
    if (tutorialData.isPresent()) {
      Tutorial tutorialUpdate = tutorialData.get();
